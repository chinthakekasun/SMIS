...
<h1 style="text-align:center;color:#4d4d4d;">Badminton</h1>
<center><div class="my-slider" style="max-width: 575px; max-height: 300px;"">
	<ul>
		<li><img width="100%" src="{{URL('images/games/badminton/1.jpg')}}"></li>
		<li><img width="100%" src="{{URL('images/games/badminton/2.jpg')}}"></li>
		<li><img width="100%" src="{{URL('images/games/badminton/3.jpg')}}"></li>
		<li><img width="100%" src="{{URL('images/games/badminton/4.jpg')}}"></li>
	</ul>
</div></center>
...
<ul>
	...
	<li>Badminto rackets are provided to the University team members.</li></br>
...
@if(!Auth::check())
	<a href="{{URL('application','badminton')}}">
